...
public struct StreamAppSelectedStream: Equatable, Sendable {
    ...
    fileprivate static func status(from runtimeStatus: AppStreamRuntimeStatusSnapshot)
        -> StreamAppStatus
    {
    ...
    fileprivate static func runtimeStatusDetail(for runtimeStatus: AppStreamRuntimeStatusSnapshot)
        -> String
    {
        switch runtimeStatus.phase {
        case .connecting:
